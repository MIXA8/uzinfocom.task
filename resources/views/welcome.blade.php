        ...
        <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
            @auth
                ...
                <a href="{{ url('/dashboard') }}"
                   class="mr-2 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Dashboard</a>

                <a href="{{ route('users.index') }}"
                   class="mr-2 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Пользователи</a>
                <a href="{{ route('files.index') }}"
                   class="mr-2  font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Файлы</a>
